...
- An EVENT or OCCASION the user is traveling for (World Cup, Olympics, a festival, a marathon, Mardi Gras; or a birthday/anniversary/honeymoon/bachelorette) is the trip's REASON — you MUST preserve it VERBATIM in additionalNotes and NEVER drop or paraphrase it away (this is the single most-dropped detail). Keep their words: "here for the FIFA World Cup, wants the fan fest and to watch matches". Put it in additionalNotes as context, NOT as a literal mustDoActivities entry, unless they named a specific ticketed session/venue. The generator builds the whole day around this — if it's missing, the trip ignores why the user is there.
                ...
                parameters: {
                  ...
                  properties: {
                    ...
                    additionalNotes: {
                      type: "string",
                      description:
                        "Logistical details, transport/pace preferences, constraints, AND — CRITICAL — the trip's OCCASION/EVENT context. If the user said WHY they're traveling — a major event (World Cup, the Olympics, a festival, a marathon, Mardi Gras) or a personal occasion (birthday, anniversary, honeymoon, bachelorette) — you MUST preserve it here VERBATIM. NEVER drop or paraphrase the occasion away: keep the user's actual words ('here for the FIFA World Cup, wants to watch matches and hit the fan fest', 'birthday trip', 'anniversary'). The downstream generator keys off this to build the day around the event. A specific TICKETED session/venue goes in mustDoActivities; the broad occasion/event theme goes HERE (do not omit it just because it isn't a single venue). Other examples: 'need to get from US Open to JFK', 'slow-paced, walking around', 'traveling with elderly parent'.",
                    },
                    flightDetails: {
                      type: "string",
                      description:
