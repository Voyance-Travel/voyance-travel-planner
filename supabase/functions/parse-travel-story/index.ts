...
const ARCHETYPES = [
  ...
  { id: 'history_hunter', name: 'The History Hunter', category: 'CURATOR', traits: ['historical-sites', 'ruins', 'ancient', 'heritage', 'museums', 'archaeology'] },
  // TRANSFORMER
  ...
  { id: 'midlife_explorer', name: 'The Rediscovery Traveler', category: 'TRANSFORMER', traits: ['bucket-list', 'new-experiences', 'rediscovery', 'adventure-lite'] },
