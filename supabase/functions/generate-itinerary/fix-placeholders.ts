...
import { detectCrossCityMention, isCrossCityAddress } from '../_shared/cross-city-filter.ts';
...
export const INLINE_FALLBACK_RESTAURANTS: Record<string, Record<string, FallbackRestaurant[]>> = {
  ...
  tokyo: {
    breakfast: [
      { name: "Bills Omotesando", address: "4-30-3 Jingumae, Shibuya, Tokyo, Japan", price: 22, description: "Home of the famous ricotta hotcakes and scrambled eggs. A bright, airy brunch institution near Omotesando." },
      { name: "Fuglen Tokyo", address: "1-16-11 Tomigaya, Shibuya, Tokyo, Japan", price: 12, description: "Oslo-born coffee bar in Tomigaya. Aeropress single-origins, Norwegian pastries, and vintage Scandinavian design." },
      { name: "Onibus Coffee Nakameguro", address: "2-14-1 Kamimeguro, Meguro, Tokyo, Japan", price: 10, description: "Beloved third-wave roaster beside the Nakameguro tracks. Pour-overs on a tiny tree-shaded balcony." },
      { name: "Centre The Bakery", address: "1-2-1 Ginza, Chuo, Tokyo, Japan", price: 16, description: "Ginza shokupan temple. Choose your loaf and toaster — the city's most coveted Japanese toast breakfast." },
      { name: "Sawamura Hiroo", address: "5-1-20 Hiroo, Shibuya, Tokyo, Japan", price: 18, description: "Mountain-style bakery-café with hearth breads, egg dishes, and a calm Hiroo morning crowd." },
      { name: "Cafe de l'Ambre", address: "8-10-15 Ginza, Chuo, Tokyo, Japan", price: 12, description: "Ginza kissaten since 1948 devoted entirely to aged coffee. A hushed, smoky shrine to the hand-drip." },
    ],
    lunch: [
      { name: "Afuri Ebisu", address: "1-1-7 Ebisu, Shibuya, Tokyo, Japan", price: 14, description: "Light yuzu-shio ramen that launched a thousand imitators. Clean citrus broth and charcoal-seared chashu." },
      { name: "Tonki", address: "1-1-2 Shimomeguro, Meguro, Tokyo, Japan", price: 20, description: "Meguro tonkatsu institution since 1939. Counter theater as the cooks fry impossibly crisp, juicy pork cutlets." },
      { name: "Kanda Matsuya", address: "1-13 Kanda Sudacho, Chiyoda, Tokyo, Japan", price: 16, description: "Hand-cut soba in a 1925 wooden townhouse. Seiro soba and tempura in a vanishing old-Tokyo setting." },
      { name: "Rokurinsha Tokyo Station", address: "1-9-1 Marunouchi, Chiyoda, Tokyo, Japan (Tokyo Station Ramen Street)", price: 13, description: "The tsukemen that defined the genre. Thick dipping broth and chewy noodles in Tokyo Station's Ramen Street." },
      { name: "Sushi Zanmai Tsukiji", address: "4-11-9 Tsukiji, Chuo, Tokyo, Japan", price: 30, description: "24-hour sushi anchor at Tsukiji Outer Market. Reliable, generous nigiri sets a step from the stalls." },
      { name: "Kagari Ginza", address: "6-4-12 Ginza, Chuo, Tokyo, Japan", price: 15, description: "Silky tori-paitan chicken ramen in a tiny Ginza alley. Creamy broth crowned with seasonal vegetables." },
    ],
    dinner: [
      { name: "Den", address: "2-3-18 Jingumae, Shibuya, Tokyo, Japan", price: 200, description: "Zaiyu Hasegawa's playful, deeply seasonal kaiseki. Perennial World's 50 Best — joyful, personal, unforgettable." },
      { name: "Narisawa", address: "2-6-15 Minami Aoyama, Minato, Tokyo, Japan", price: 320, description: "'Innovative Satoyama' tasting tracing Japan's landscape. One of Asia's most lauded fine-dining rooms." },
      { name: "Gonpachi Nishi-Azabu", address: "1-13-11 Nishi-Azabu, Minato, Tokyo, Japan", price: 50, description: "The soaring wooden izakaya that inspired Kill Bill. Robata skewers, soba, and sake under lantern light." },
      { name: "Birdland Ginza", address: "4-2-15 Ginza, Chuo, Tokyo, Japan", price: 90, description: "Michelin-starred yakitori beneath Ginza. Jidori chicken grilled part by part over binchotan — a master class." },
      { name: "Ukai-tei Ginza", address: "5-15-8 Ginza, Chuo, Tokyo, Japan", price: 160, description: "Teppanyaki theater in an opulent Art Nouveau room. Wagyu and seafood seared tableside with quiet precision." },
      { name: "Ichiran Shibuya", address: "1-22-7 Jinnan, Shibuya, Tokyo, Japan", price: 14, description: "Solo-booth tonkotsu ramen, customizable to the noodle's firmness. A focused, late-night Tokyo ritual." },
    ],
  },
  "new york": {
    breakfast: [
      { name: "Russ & Daughters Cafe", address: "127 Orchard St, New York, NY, USA", price: 28, description: "Sit-down spinoff of the 1914 appetizing icon. Bagels, house-cured lox, and egg creams on the Lower East Side." },
      { name: "Balthazar", address: "80 Spring St, New York, NY, USA", price: 32, description: "The quintessential SoHo French brasserie. Pastry basket, eggs Benedict, and bustling all-day glamour." },
      { name: "Clinton St. Baking Company", address: "4 Clinton St, New York, NY, USA", price: 24, description: "Legendary pancakes with warm maple butter. The benchmark Lower East Side brunch — expect a weekend wait." },
      { name: "Jack's Wife Freda", address: "224 Lafayette St, New York, NY, USA", price: 26, description: "Mediterranean-diner brunch with green shakshuka and rosewater waffles. Sunny, perennially packed." },
      { name: "Buvette", address: "42 Grove St, New York, NY, USA", price: 28, description: "Jody Williams's jewel-box West Village café. Steamed eggs, croque monsieur, and tiny perfect coffees." },
      { name: "Sarabeth's Central Park South", address: "40 Central Park S, New York, NY, USA", price: 30, description: "Classic NYC brunch institution. Lemon ricotta pancakes and 'Goldie Lox' eggs near the park." },
    ],
    lunch: [
      { name: "Katz's Delicatessen", address: "205 E Houston St, New York, NY, USA", price: 28, description: "Since 1888 — the definitive hand-carved pastrami on rye. A loud, cash-flowing New York rite of passage." },
      { name: "Joe's Pizza", address: "7 Carmine St, New York, NY, USA", price: 5, description: "The platonic NY slice since 1975. Thin, foldable, perfectly greasy — eaten standing in Greenwich Village." },
      { name: "Xi'an Famous Foods", address: "81 St Marks Pl, New York, NY, USA", price: 12, description: "Hand-pulled, cumin-lamb biang-biang noodles. Fiery, numbing, and gloriously cheap." },
      { name: "Los Tacos No. 1", address: "75 9th Ave, New York, NY, USA (Chelsea Market)", price: 14, description: "Chelsea Market's perennial queue. Adobada and nopal tacos on house-pressed tortillas — no seats, all flavor." },
      { name: "Shake Shack Madison Square Park", address: "Madison Ave & E 23rd St, New York, NY, USA", price: 14, description: "The original kiosk where it all began. ShackBurger and frozen custard under the park trees." },
      { name: "Mamoun's Falafel", address: "119 MacDougal St, New York, NY, USA", price: 8, description: "Greenwich Village falafel since 1971. Crisp, herby, and dressed in fiery house hot sauce." },
    ],
    dinner: [
      { name: "Le Bernardin", address: "155 W 51st St, New York, NY, USA", price: 220, description: "Eric Ripert's three-Michelin seafood temple. Precise, luminous fish cookery — among the world's finest." },
      { name: "Gramercy Tavern", address: "42 E 20th St, New York, NY, USA", price: 130, description: "Danny Meyer's beloved New American. Seasonal tasting in the dining room or à la carte by the fire." },
      { name: "Peter Luger Steak House", address: "178 Broadway, Brooklyn, New York, NY, USA", price: 110, description: "Since 1887 under the Williamsburg Bridge. Dry-aged porterhouse, sizzling butter, gruff old-school service." },
      { name: "Carbone", address: "181 Thompson St, New York, NY, USA", price: 120, description: "Theatrical Italian-American in Greenwich Village. Spicy rigatoni vodka and tableside Caesar — book far ahead." },
      { name: "Lilia", address: "567 Union Ave, Brooklyn, New York, NY, USA", price: 85, description: "Missy Robbins's Williamsburg pasta benchmark. Mafaldine and wood-grilled seafood in a converted auto shop." },
      { name: "Gage & Tollner", address: "372 Fulton St, Brooklyn, New York, NY, USA", price: 90, description: "Restored 1879 landmark chophouse. Oysters, Welsh rarebit, and martinis under gaslit chandeliers." },
    ],
  },
  dubai: {
    breakfast: [
      { name: "Arabian Tea House", address: "Al Fahidi Historical District, Bur Dubai, Dubai, UAE", price: 18, description: "Courtyard heritage café in Al Fahidi. The Emirati breakfast spread — balaleet, khameer, chickpeas — under bougainvillea." },
      { name: "Tom & Serg", address: "Al Joud Center, Al Quoz, Dubai, UAE", price: 22, description: "Warehouse-district pioneer of Dubai's brunch scene. Big breakfasts, flat whites, and an industrial-cool crowd." },
      { name: "Common Grounds", address: "Mall of the Emirates, Dubai, UAE", price: 20, description: "Polished all-day café. Truffle eggs, açai bowls, and dependable specialty coffee between shopping floors." },
      { name: "The Sum of Us", address: "Burj Al Salam, Trade Centre, Dubai, UAE", price: 24, description: "In-house roastery and bakery. Cult cruffins, shakshuka, and some of the city's most serious coffee." },
      { name: "Brunch & Cake", address: "Bluewaters Island, Dubai, UAE", price: 26, description: "Barcelona import known for theatrical, Instagram-perfect breakfasts overlooking the marina." },
    ],
    lunch: [
      { name: "Ravi Restaurant", address: "Al Satwa, Dubai, UAE", price: 10, description: "Pakistani institution since 1978. Karahi, dal, and fresh naan — the city's most beloved cheap, soulful lunch." },
      { name: "Al Ustad Special Kabab", address: "Al Mussallah Rd, Bur Dubai, Dubai, UAE", price: 14, description: "Iranian kebab legend since 1978, walls papered with celebrity photos. Charcoal-grilled chelo kebab perfection." },
      { name: "Bu Qtair", address: "Fishing Harbour 2, Jumeirah, Dubai, UAE", price: 16, description: "Cult seafood shack near the beach. Pick the day's catch, get it masala-fried — plastic chairs, unforgettable fish." },
      { name: "Logma", address: "BoxPark, Al Wasl, Dubai, UAE", price: 18, description: "Modern Khaleeji comfort food. Chicken machboos, balaleet sliders, and karak chai in a buzzy setting." },
      { name: "Pai Thai", address: "Al Qasr, Madinat Jumeirah, Dubai, UAE", price: 45, description: "Arrive by abra through the canals for refined Thai by the waterways, with Burj Al Arab views." },
    ],
    dinner: [
      { name: "Pierchic", address: "Al Qasr, Madinat Jumeirah, Dubai, UAE", price: 120, description: "Overwater seafood restaurant on a private pier. Sunset oysters and turbot with the Burj Al Arab as backdrop." },
      { name: "Zuma Dubai", address: "Gate Village 06, DIFC, Dubai, UAE", price: 110, description: "The flagship of the global izakaya phenomenon. Robata-grilled wagyu, miso black cod, electric DIFC energy." },
      { name: "Ossiano", address: "Atlantis The Palm, Dubai, UAE", price: 180, description: "Michelin-starred underwater dining beside a vast aquarium. Gregoire Berger's poetic seafood tasting." },
      { name: "COYA Dubai", address: "Restaurant Village, Four Seasons Jumeirah, Dubai, UAE", price: 100, description: "Vibrant Peruvian with ceviches, anticuchos, and pisco. A lively, design-led Latin night out." },
      { name: "Al Hadheerah", address: "Bab Al Shams Desert Resort, Dubai, UAE", price: 130, description: "Open-air desert feast with live grills, falconry, and Arabian entertainment under the dunes and stars." },
    ],
  },
  bangkok: {
    breakfast: [
      { name: "Jok Prince", address: "1391 Charoen Krung Rd, Bang Rak, Bangkok, Thailand", price: 4, description: "Michelin Bib Gourmet rice congee cooked over charcoal for a faint smokiness. A 50-year Charoen Krung morning ritual." },
      { name: "On Lok Yun", address: "72 Charoen Krung Rd, Phra Nakhon, Bangkok, Thailand", price: 5, description: "Old-school 1930s coffee shop. Toast with custard, eggs in a glass, and kafae boran — pure retro Bangkok." },
      { name: "Roast", address: "The Commons, Thonglor 17, Bangkok, Thailand", price: 14, description: "Bright Thonglor all-day café. Specialty coffee, eggs Benedict, and the city's polished brunch crowd." },
      { name: "Toby's", address: "75 Sukhumvit Soi 38, Bangkok, Thailand", price: 12, description: "Melbourne-style café off Thonglor. Big breakfasts, smashed avo, and serious flat whites." },
      { name: "Patom Organic Living", address: "Sukhumvit 49/6, Bangkok, Thailand", price: 13, description: "Glass garden pavilion serving organic farm breakfasts, butterfly-pea drinks, and house bakery in a leafy hideaway." },
    ],
    lunch: [
      { name: "Thip Samai", address: "313-315 Maha Chai Rd, Phra Nakhon, Bangkok, Thailand", price: 6, description: "Bangkok's most famous pad thai since 1966, wrapped in a thin egg crepe. Worth the line near the Golden Mount." },
      { name: "Krua Apsorn", address: "Dinso Rd, Phra Nakhon, Bangkok, Thailand", price: 12, description: "Beloved home-style Thai. Crab-and-yellow-chili stir-fry and stewed beef that locals queue for." },
      { name: "Nai Mong Hoi Thod", address: "539 Phlap Phla Chai Rd, Chinatown, Bangkok, Thailand", price: 6, description: "Chinatown's crispiest oyster omelette (hoi thod). A greasy, golden Yaowarat lunch institution." },
      { name: "Somtum Der", address: "5/5 Sala Daeng Rd, Silom, Bangkok, Thailand", price: 10, description: "Michelin-recognized Isaan. Pounded-to-order som tum, grilled chicken, and sticky rice with real northeastern fire." },
      { name: "Err Urban Rustic Thai", address: "394/35 Maha Rat Rd, Phra Nakhon, Bangkok, Thailand", price: 18, description: "Playful old-town Thai from the Bo.lan team. Grilled skewers, naam phrik, and craft Thai cocktails." },
    ],
    dinner: [
      { name: "Gaggan Anand", address: "68/4 Soi Langsuan, Ploenchit, Bangkok, Thailand", price: 250, description: "Progressive Indian theater from one of Asia's most celebrated chefs. An emoji menu and relentless invention." },
      { name: "Le Du", address: "399/3 Silom Soi 7, Bangkok, Thailand", price: 120, description: "Thitid Tassanakajohn's modern Thai, voted Asia's best. Hyper-seasonal Thai ingredients, refined tasting format." },
      { name: "Sorn", address: "56 Sukhumvit Soi 26, Bangkok, Thailand", price: 200, description: "Two-Michelin southern Thai. Heritage recipes, prized crab, and chili heat treated as fine dining." },
      { name: "Supanniga Eating Room", address: "160/11 Sukhumvit 55 (Thonglor), Bangkok, Thailand", price: 25, description: "Grandmother's Trat- and Khon Kaen-style recipes in a stylish room. Moo cha muang and crab fried rice." },
      { name: "Nahm", address: "27 South Sathorn Rd, COMO Metropolitan, Bangkok, Thailand", price: 90, description: "Landmark fine Thai built on royal and regional recipes. Bold, layered curries and relishes." },
    ],
  },
  singapore: {
    breakfast: [
      { name: "Ya Kun Kaya Toast", address: "18 China St, Far East Square, Singapore", price: 5, description: "Since 1944 — the definitive kaya toast set with soft eggs and kopi. A morning ritual in a heritage shophouse." },
      { name: "Tiong Bahru Bakery", address: "56 Eng Hoon St, Tiong Bahru, Singapore", price: 10, description: "Gcontran Cherrier croissants in the artsy Tiong Bahru estate. The kouign-amann is the move." },
      { name: "Chye Seng Huat Hardware", address: "150 Tyrwhitt Rd, Singapore", price: 12, description: "Roastery-café in a converted hardware shop. Single-origin pours, kaya French toast, courtyard calm." },
      { name: "Killiney Kopitiam", address: "67 Killiney Rd, Singapore", price: 5, description: "Old-school kopitiam since 1919. Charcoal-toasted kaya toast, half-boiled eggs, and thick local coffee." },
      { name: "Toast Box", address: "252 North Bridge Rd, Raffles City, Singapore", price: 6, description: "Polished modern take on the traditional toast set. Thick toast, kaya, and a reliable nanyang coffee." },
    ],
    lunch: [
      { name: "Tian Tian Hainanese Chicken Rice", address: "1 Kadayanallur St, Maxwell Food Centre, Singapore", price: 5, description: "The most famous chicken rice in Singapore. Silky poached chicken and fragrant rice — the hawker benchmark." },
      { name: "Hill Street Tai Hwa Pork Noodle", address: "466 Crawford Ln, Singapore", price: 7, description: "Michelin-starred bak chor mee. Springy noodles tossed in vinegar-chili with pork and crispy lard — worth the queue." },
      { name: "328 Katong Laksa", address: "51 East Coast Rd, Singapore", price: 6, description: "Katong-style laksa eaten with a spoon only. Rich coconut-prawn gravy and cockles — a neighborhood classic." },
      { name: "Lau Pa Sat", address: "18 Raffles Quay, Singapore", price: 10, description: "Victorian cast-iron hawker hall in the CBD. Satay street fires up at night; noodles and rice all day." },
      { name: "Sungei Road Laksa", address: "27 Jalan Berseh, Singapore", price: 4, description: "Charcoal-kept laksa with a cult following. Smoky, cheap, and ladled with no-frills devotion." },
    ],
    dinner: [
      { name: "Odette", address: "1 St Andrew's Rd, National Gallery, Singapore", price: 280, description: "Three-Michelin modern French from Julien Royer. Elegant, produce-led tasting in a rosy gallery room." },
      { name: "Burnt Ends", address: "7 Dempsey Rd, Singapore", price: 150, description: "One-Michelin Australian barbecue around an open custom kiln. Beef-marmalade sanger and pulled-pork brilliance." },
      { name: "Jumbo Seafood", address: "30 Merchant Rd, Riverside Point, Singapore", price: 60, description: "The classic chilli-crab dinner by the river. Order extra mantou buns to mop the sweet-spicy gravy." },
      { name: "Candlenut", address: "17A Dempsey Rd, Singapore", price: 90, description: "The world's first Michelin-starred Peranakan. Refined buah keluak and rendang rooted in family recipes." },
      { name: "Long Chim", address: "2 Bayfront Ave, Marina Bay Sands, Singapore", price: 70, description: "David Thompson's street-food-driven Thai. Fiery curries and som tum with a Marina Bay backdrop." },
    ],
  },
  sydney: {
    breakfast: [
      { name: "Bills Darlinghurst", address: "433 Liverpool St, Darlinghurst, Sydney, Australia", price: 22, description: "Bill Granger's original — birthplace of the ricotta hotcakes and creamy scrambled eggs the world copied." },
      { name: "The Grounds of Alexandria", address: "7A/2 Huntley St, Alexandria, Sydney, Australia", price: 24, description: "Sprawling garden café in a former industrial yard. Big brunches, a coffee roastery, and resident animals." },
      { name: "Reuben Hills", address: "61 Albion St, Surry Hills, Sydney, Australia", price: 20, description: "Surry Hills roastery in a terrace. Latin-leaning breakfasts and some of the city's most respected coffee." },
      { name: "Bourke Street Bakery", address: "633 Bourke St, Surry Hills, Sydney, Australia", price: 12, description: "The cult Surry Hills bakery. Sausage rolls, ginger brûlée tart, and crusty sourdough from a corner shopfront." },
      { name: "Single O Surry Hills", address: "60-64 Reservoir St, Surry Hills, Sydney, Australia", price: 14, description: "Pioneering specialty roaster. Brunch plates and meticulous filter coffee in a buzzy warehouse space." },
    ],
    lunch: [
      { name: "Mary's Newtown", address: "6 Mary St, Newtown, Sydney, Australia", price: 18, description: "Dive-bar burger legend in a former union hall. The cheeseburger and fried chicken with a cold beer." },
      { name: "Chat Thai", address: "20 Campbell St, Haymarket, Sydney, Australia", price: 20, description: "Beloved Haymarket Thai that perpetually queues. Boat noodles, betel-leaf bites, and northern-Thai depth." },
      { name: "Spice Temple", address: "10 Bligh St, Sydney, Australia", price: 45, description: "Neil Perry's subterranean regional-Chinese den. Fiery Sichuan and Hunan plates beneath the CBD." },
      { name: "Continental Deli Newtown", address: "210 Australia St, Newtown, Sydney, Australia", price: 25, description: "Playful deli-bar with tinned-fish boards, 'martinis on tap,' and excellent sandwiches in Newtown." },
      { name: "Sydney Fish Market", address: "Bank St, Pyrmont, Sydney, Australia", price: 25, description: "Pick fresh oysters, prawns, and grilled barramundi straight from the stalls and eat harbourside." },
    ],
    dinner: [
      { name: "Quay", address: "Upper Level, Overseas Passenger Terminal, The Rocks, Sydney, Australia", price: 220, description: "Peter Gilmore's harbourside icon. Sculptural tasting menus with Opera House and Bridge views — and the famous snow egg." },
      { name: "Firedoor", address: "33-37 Mary St, Surry Hills, Sydney, Australia", price: 130, description: "Lennox Hastie cooks everything over wood and flame — no gas, no electricity. Pure live-fire mastery." },
      { name: "Saint Peter", address: "362 Oxford St, Paddington, Sydney, Australia", price: 120, description: "Josh Niland's revolutionary whole-fish cookery. Nose-to-tail seafood that changed how the world cooks fish." },
      { name: "Bennelong", address: "Sydney Opera House, Bennelong Point, Sydney, Australia", price: 160, description: "Fine dining inside the Opera House sails. Peter Gilmore's coastal Australian under the soaring shells." },
      { name: "Tetsuya's", address: "529 Kent St, Sydney, Australia", price: 240, description: "Tetsuya Wakuda's serene Japanese-French degustation. The confit ocean trout is a national treasure." },
    ],
  },
  istanbul: {
    breakfast: [
      { name: "Van Kahvaltı Evi", address: "Defterdar Yokuşu 52, Cihangir, Istanbul, Turkey", price: 16, description: "The full eastern-Turkish kahvaltı spread — kavut, otlu peynir, honeyed kaymak — in a buzzy Cihangir room." },
      { name: "Privato Cafe", address: "Tımarcı Sokak 3B, Galata, Istanbul, Turkey", price: 15, description: "Cozy Galata serme-breakfast with homemade jams, menemen, and bottomless Turkish tea near the tower." },
      { name: "Karaköy Güllüoğlu", address: "Rıhtım Caddesi 3-4, Karaköy, Istanbul, Turkey", price: 8, description: "Since 1949 — the city's most famous baklava and warm su böreği, eaten standing by the ferry docks." },
      { name: "Namlı Gurme", address: "Rıhtım Caddesi 1, Karaköy, Istanbul, Turkey", price: 18, description: "Sprawling delicatessen breakfast by the water. Endless cheeses, olives, and eggs with Golden Horn views." },
      { name: "Mums Cafe", address: "Akarsu Yokuşu 14, Cihangir, Istanbul, Turkey", price: 14, description: "Laid-back Cihangir corner for unhurried serpme breakfasts and strong coffee among locals." },
    ],
    lunch: [
      { name: "Çiya Sofrası", address: "Güneşli Bahçe Sokak 43, Kadıköy, Istanbul, Turkey", price: 14, description: "Musa Dağdeviren's Anatolian living museum. Rotating regional stews and kebabs that anthropologists study." },
      { name: "Hamdi Restaurant", address: "Kalçın Sokak 17, Eminönü, Istanbul, Turkey", price: 22, description: "Rooftop kebab institution above the Spice Bazaar. Pistachio kebab and Golden Horn views since 1968." },
      { name: "Dürümzade", address: "Kameriye Sokak 7, Beyoğlu, Istanbul, Turkey", price: 7, description: "The Anthony Bourdain dürüm. Smoky charcoal-grilled kebabs wrapped in thin lavash off İstiklal." },
      { name: "Tarihi Sultanahmet Köftecisi", address: "Divanyolu Caddesi 12, Sultanahmet, Istanbul, Turkey", price: 12, description: "Since 1920 — grilled köfte, white-bean piyaz, and pickles in the old city. A no-frills classic." },
      { name: "Balıkçı Sabahattin", address: "Seyit Hasan Koyu Sokak 1, Cankurtaran, Istanbul, Turkey", price: 40, description: "Garden seafood meyhane in a wooden Ottoman house. Mezes, raki, and the day's catch near the sea walls." },
    ],
    dinner: [
      { name: "Mikla", address: "The Marmara Pera, Meşrutiyet Caddesi 15, Beyoğlu, Istanbul, Turkey", price: 110, description: "Mehmet Gürs's rooftop 'New Anatolian' tasting. Nordic-Turkish cooking with a 360° skyline panorama." },
      { name: "Neolokal", address: "SALT Galata, Bankalar Caddesi 11, Karaköy, Istanbul, Turkey", price: 90, description: "Maksut Aşkar reimagines Anatolian heritage dishes with a sustainable, modern eye and Bosphorus views." },
      { name: "Asitane", address: "Kariye Camii Sokak 6, Edirnekapı, Istanbul, Turkey", price: 55, description: "Researched Ottoman-palace cuisine beside the Chora. Quince-stuffed lamb and 15th-century recipes revived." },
      { name: "Karaköy Lokantası", address: "Kemankeş Caddesi 37A, Karaköy, Istanbul, Turkey", price: 35, description: "Turquoise-tiled meyhane beloved by locals. Daytime esnaf lokantası, evening mezes and raki." },
      { name: "Lokanta Maya", address: "Kemankeş Caddesi 35A, Karaköy, Istanbul, Turkey", price: 45, description: "Didem Şenol's bright, contemporary Aegean-leaning cooking near the docks. Refined, herb-forward Turkish." },
    ],
  },
  "mexico city": {
    breakfast: [
      { name: "Panadería Rosetta", address: "Colima 179, Roma Norte, Mexico City, Mexico", price: 12, description: "Elena Reygadas's cult bakery. Guava rolls, concha pan, and excellent coffee in a Roma Norte townhouse." },
      { name: "Lalo!", address: "Zacatecas 173, Roma Norte, Mexico City, Mexico", price: 14, description: "Bright, muralled all-day spot from chef Eduardo García. Chilaquiles, pan dulce, and great eggs." },
      { name: "Maque", address: "Ámsterdam 154, Condesa, Mexico City, Mexico", price: 12, description: "Beloved Condesa café for conchas dipped in hot chocolate and traditional almuerzo on a leafy corner." },
      { name: "Café El Jarocho", address: "Cuauhtémoc 134, Coyoacán, Mexico City, Mexico", price: 4, description: "Coyoacán coffee institution since 1953. Café de olla and pan to go, sipped on the plaza benches." },
      { name: "Cardinal Casa de Café", address: "Córdoba 132, Roma Norte, Mexico City, Mexico", price: 10, description: "Specialty roaster spotlighting Mexican beans. Meticulous pour-overs and a small, excellent breakfast." },
    ],
    lunch: [
      { name: "Contramar", address: "Durango 200, Roma Norte, Mexico City, Mexico", price: 35, description: "The legendary lunch institution. Tuna tostadas and the split red-and-green pescado a la talla — book ahead." },
      { name: "El Turix", address: "Emilio Castelar 212, Polanco, Mexico City, Mexico", price: 6, description: "Yucatán cochinita pibil tacos and panuchos at a tiny Polanco counter. Smoky, citrusy, perfect." },
      { name: "Los Cocuyos", address: "Bolívar 56, Centro Histórico, Mexico City, Mexico", price: 5, description: "The downtown taquería Bourdain loved. Suadero and longaniza tacos from bubbling vats, day and night." },
      { name: "Taquería Orinoco", address: "Álvaro Obregón 179, Roma Norte, Mexico City, Mexico", price: 8, description: "Northern-style trompo and chicharrón tacos with a cult following. Crisp, fast, and irresistible." },
      { name: "El Califa", address: "Altata 22, Condesa, Mexico City, Mexico", price: 12, description: "Polished late-night taquería. Alambres and gaonera tacos with house salsas that locals swear by." },
    ],
    dinner: [
      { name: "Pujol", address: "Tennyson 133, Polanco, Mexico City, Mexico", price: 180, description: "Enrique Olvera's landmark. The aged mole madre and smoky baby corn redefined modern Mexican fine dining." },
      { name: "Quintonil", address: "Newton 55, Polanco, Mexico City, Mexico", price: 160, description: "Jorge Vallejo's produce-driven tasting, perennially among the world's best. Herbs and heirloom corn front and center." },
      { name: "Máximo Bistrot", address: "Álvaro Obregón 65 bis, Roma Norte, Mexico City, Mexico", price: 70, description: "Eduardo García's market-led bistro. French technique meets Mexican ingredients in a warm Roma room." },
      { name: "Rosetta", address: "Colima 166, Roma Norte, Mexico City, Mexico", price: 90, description: "Elena Reygadas's Italian-Mexican in a romantic Roma mansion. Plant-forward pastas and impeccable bread." },
      { name: "El Cardenal Centro", address: "Palma 23, Centro Histórico, Mexico City, Mexico", price: 35, description: "Genteel traditional Mexican. Pan de nata, hot chocolate, and definitive almuerzo near the Zócalo — also a fine dinner." },
    ],
  },
};
