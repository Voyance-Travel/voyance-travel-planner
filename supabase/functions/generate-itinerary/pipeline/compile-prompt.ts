...
7b. CHECKOUT IS THE LAST NON-LOGISTICS CARD: On the final day in any city, the hotel checkout is the LAST non-logistics activity of the day. After checkout you may emit ONLY: airport/station transport, security/boarding, or the flight/train itself. NEVER schedule sightseeing, wellness, dining, drinks, walks, strolls, gardens, viewpoints, or any "return to hotel" / hotel-grounds activity AFTER checkout — even if hours remain before departure. If the gap before departure is large, place the checkout LATER (close to the departure-buffer window: flight − 3h, train − 2h, minus 30 minutes for the checkout itself), NOT earlier in the day. Emit only ONE departure-transport card with explicit start/end times within that buffer window. Wrong: checkout 17:50 → "transfer to airport" (no time) → garden 19:30 → stroll at hotel 21:30 → taxi 22:15. Right: garden 17:00 → checkout 19:15 → taxi to airport 19:45 → security 20:30 → flight 22:30.
