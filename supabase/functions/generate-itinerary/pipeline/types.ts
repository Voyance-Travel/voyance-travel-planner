...
export const FAILURE_CODES = {
  ...
  DEPARTURE_TRANSPORT_UNTIMED: 'DEPARTURE_TRANSPORT_UNTIMED',
  ...
  // Semantic gate (validation-gate.ts) — added 2026-05
  PUNCTUATION_ONLY_FIELD:    'PUNCTUATION_ONLY_FIELD',
  ...
  DESCRIPTION_GHOST_REFERENCE: 'DESCRIPTION_GHOST_REFERENCE',
