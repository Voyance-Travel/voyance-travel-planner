...
const FALLBACK_RESTAURANTS: Record<string, Record<string, FallbackVenue[]>> = {
  ...
  'paris': {
    breakfast: [
      ...
      { name: 'Angelina', neighborhood: 'Tuileries', address: '226 R. de Rivoli, Paris' },
      { name: 'Stohrer', neighborhood: 'Montorgueil', address: '51 R. Montorgueil, Paris' },
      { name: 'Ladurée', neighborhood: 'Champs-Élysées', address: '75 Av. des Champs-Élysées, Paris' },
      { name: 'Holybelly', neighborhood: 'Canal Saint-Martin', address: '19 R. Lucien Sampaix, Paris' },
      { name: 'Boot Café', neighborhood: 'Marais', address: '19 R. du Pont aux Choux, Paris' },
      { name: 'Ob-La-Di', neighborhood: 'Marais', address: '54 R. de Saintonge, Paris' },
    ],
    lunch: [
      ...
      { name: 'Les Philosophes', neighborhood: 'Marais', address: '28 R. Vieille du Temple, Paris' },
      { name: 'Pink Mamma', neighborhood: 'Oberkampf', address: '20bis R. de Douai, Paris' },
      { name: 'Robert et Louise', neighborhood: 'Marais', address: '64 R. Vieille du Temple, Paris' },
      { name: 'Bofinger', neighborhood: 'Bastille', address: '5-7 R. de la Bastille, Paris' },
      { name: 'Le Comptoir du Relais', neighborhood: 'Saint-Germain', address: '9 Carrefour de l\'Odéon, Paris' },
    ],
    dinner: [
      ...
      { name: 'Le Train Bleu', neighborhood: 'Gare de Lyon', address: 'Pl. Louis-Armand, Paris' },
      { name: 'Brasserie Lipp', neighborhood: 'Saint-Germain-des-Prés', address: '151 Bd Saint-Germain, Paris' },
      { name: "Le Relais de l'Entrecôte", neighborhood: 'Saint-Germain', address: '20 R. Marbeuf, Paris' },
      { name: 'Drouant', neighborhood: 'Opéra', address: '16-18 R. Gaillon, Paris' },
      { name: 'Le Voltaire', neighborhood: 'Saint-Germain', address: '27 Quai Voltaire, Paris' },
      { name: 'Chez Georges', neighborhood: 'Bourse', address: '1 R. du Mail, Paris' },
    ],
  },
  'berlin': {
    breakfast: [
