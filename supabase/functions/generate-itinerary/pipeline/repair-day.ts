...
const FALLBACK_RESTAURANTS: Record<string, Record<string, FallbackVenue[]>> = {
  'lisbon': {
    breakfast: [
      { name: 'Heim Café', neighborhood: 'Chiado', address: 'R. de Santos-o-Velho 2, Lisbon', price: 15, description: 'Cozy brunch spot in Santos. Excellent avocado toast, açaí bowls, and specialty coffee.' },
      { name: 'Copenhagen Coffee Lab', neighborhood: 'Chiado', address: 'R. Nova da Piedade 10, Lisbon', price: 12, description: 'Scandinavian-style specialty coffee roaster with minimalist Chiado setting.' },
      { name: 'Hello Kristof', neighborhood: 'Príncipe Real', address: 'R. do Poço dos Negros 103, Lisbon', price: 14, description: 'Creative brunch in a beautiful tiled building. Great eggs and fresh pastries.' },
      { name: 'The Mill', neighborhood: 'Santos', address: 'R. do Poço dos Negros 1, Lisbon', price: 12, description: 'Specialty coffee and fresh-baked goods in a cozy Santos setting.' },
      { name: 'Nicolau Lisboa', neighborhood: 'Rossio', address: 'R. de São Nicolau 17, Lisbon', price: 14, description: 'Modern café near Rossio square with great eggs Benedict and fresh juices.' },
    ],
    lunch: [
      { name: 'Cervejaria Ramiro', neighborhood: 'Intendente', address: 'Av. Almirante Reis 1H, Lisbon', price: 45, description: 'Legendary seafood beer hall. Tiger prawns, percebes, and steak sandwich to finish.' },
      { name: 'Ponto Final', neighborhood: 'Cacilhas', address: 'R. do Ginjal 72, Almada', price: 25, description: 'Waterfront seafood across the Tagus. Stunning views and grilled fish.' },
      { name: 'O Velho Eurico', neighborhood: 'Alfama', address: 'Largo de São Cristóvão 3, Lisbon', price: 20, description: 'Old-school Alfama tavern. Authentic home-style Portuguese cooking.' },
      { name: 'A Cevicheria', neighborhood: 'Príncipe Real', address: 'R. Dom Pedro V 129, Lisbon', price: 40, description: 'Peruvian-Portuguese fusion with creative ceviches under a hanging octopus.' },
      { name: 'Café de São Bento', neighborhood: 'São Bento', address: 'R. de São Bento 212, Lisbon', price: 50, description: 'Classic Lisbon steakhouse. Prego steak sandwich and garlic prawns.' },
    ],
    dinner: [
      { name: 'Sacramento do Chiado', neighborhood: 'Chiado', address: 'R. do Sacramento 26, Lisbon', price: 45, description: 'Converted church with Portuguese cuisine and a modern twist.' },
      { name: 'Solar dos Presuntos', neighborhood: 'Restauradores', address: 'R. das Portas de Santo Antão 150, Lisbon', price: 55, description: 'Minho-style cooking. Legendary presunto and seafood rice.' },
      { name: 'Sea Me', neighborhood: 'Chiado', address: 'R. do Loreto 21, Lisbon', price: 50, description: 'Modern seafood and sushi with a Portuguese twist in the heart of Chiado.' },
      { name: 'Mini Bar Teatro', neighborhood: 'Chiado', address: 'R. António Maria Cardoso 58, Lisbon', price: 60, description: 'José Avillez\'s playful tapas bar in a former theater. Creative small plates.' },
      { name: 'Pharmácia', neighborhood: 'Santa Catarina', address: 'R. Marechal Saldanha 1, Lisbon', price: 40, description: 'Pharmacy-themed restaurant with creative Portuguese dishes and Tagus views.' },
    ],
  },
  'porto': {
    breakfast: [
      { name: 'Mesa 325', neighborhood: 'Ribeira', address: 'R. de Santa Catarina 325, Porto', price: 12, description: 'Popular brunch spot on Porto\'s main shopping street.' },
      { name: 'Combi Coffee Roasters', neighborhood: 'Cedofeita', address: 'R. de Passos Manuel 27, Porto', price: 10, description: 'Specialty coffee roastery with excellent pastries.' },
    ],
    lunch: [
      { name: 'Cantinho do Avillez', neighborhood: 'Ribeira', address: 'R. de Mouzinho da Silveira 166, Porto', price: 35, description: 'José Avillez\'s Porto outpost. Modern Portuguese cuisine.' },
      { name: 'Café Santiago', neighborhood: 'Baixa', address: 'R. de Passos Manuel 226, Porto', price: 18, description: 'Home of Porto\'s best francesinha — the iconic meat sandwich.' },
    ],
    dinner: [
      { name: 'Pedro Lemos', neighborhood: 'Foz', address: 'R. do Padre Luís Cabral 974, Porto', price: 120, description: 'Michelin-starred chef\'s modern Portuguese tasting menu.' },
      { name: 'Cafeína', neighborhood: 'Foz do Douro', address: 'R. do Padrão 100, Porto', price: 45, description: 'Stylish seafood restaurant near the ocean in Foz.' },
    ],
  },
  'barcelona': {
    breakfast: [
      { name: 'Federal Café', neighborhood: 'Gòtic', address: 'Passatge de la Pau 11, Barcelona', price: 14, description: 'Australian-style brunch café in the Gothic Quarter.' },
      { name: 'Flax & Kale', neighborhood: 'Raval', address: 'C/ dels Tallers 74B, Barcelona', price: 16, description: 'Health-focused brunch with creative plant-based options.' },
    ],
    lunch: [
      { name: 'Can Culleretes', neighborhood: 'Gòtic', address: "C/ d'en Quintana 5, Barcelona", price: 25, description: 'Barcelona\'s oldest restaurant (1786). Traditional Catalan home cooking.' },
      { name: 'La Pepita', neighborhood: 'Gràcia', address: 'C/ de Còrsega 343, Barcelona', price: 20, description: 'Creative tapas in the bohemian Gràcia neighborhood.' },
    ],
    dinner: [
      { name: 'Tickets', neighborhood: 'Poble-sec', address: 'Av. del Paral·lel 164, Barcelona', price: 80, description: 'Albert Adrià\'s playful tapas bar. Creative molecular gastronomy.' },
      { name: 'Can Paixano', neighborhood: 'Barceloneta', address: 'C/ de la Reina Cristina 7, Barcelona', price: 20, description: 'Standing-room cava bar with excellent charcuterie. A local institution.' },
    ],
  },
  'paris': {
    breakfast: [
      { name: 'Café de Flore', neighborhood: 'Saint-Germain-des-Prés', address: '172 Bd Saint-Germain, Paris', price: 35, description: 'Iconic Left Bank café with Art Deco interior and literary history.' },
      { name: 'Carette', neighborhood: 'Trocadéro', address: '4 Pl. du Trocadéro et du 11 Novembre, Paris', price: 30, description: 'Elegant patisserie with Eiffel Tower views from the terrace.' },
      { name: 'Du Pain et des Idées', neighborhood: 'Canal Saint-Martin', address: '34 R. Yves Toudic, Paris', price: 12, description: 'Legendary bakery. Their pain des amis and escargot pastry are unmissable.' },
      { name: 'Claus Paris', neighborhood: 'Louvre', address: '14 R. Jean-Jacques Rousseau, Paris', price: 28, description: 'Haute couture of breakfast. Artisanal granola and organic eggs.' },
      { name: 'Angelina', neighborhood: 'Tuileries', address: '226 R. de Rivoli, Paris', price: 30, description: 'Famous for their Mont-Blanc pastry and thick African hot chocolate.' },
      { name: 'Stohrer', neighborhood: 'Montorgueil', address: '51 R. Montorgueil, Paris', price: 15, description: 'Paris\'s oldest pâtisserie (1730). Home of the baba au rhum.' },
      { name: 'Ladurée', neighborhood: 'Champs-Élysées', address: '75 Av. des Champs-Élysées, Paris', price: 35, description: 'The original macaron house. Opulent tearoom experience.' },
      { name: 'Holybelly', neighborhood: 'Canal Saint-Martin', address: '19 R. Lucien Sampaix, Paris', price: 18, description: 'Best brunch in Paris. Fluffy pancakes and specialty coffee.' },
      { name: 'Boot Café', neighborhood: 'Marais', address: '19 R. du Pont aux Choux, Paris', price: 12, description: 'Tiny specialty coffee shop in the Marais with perfect espresso.' },
      { name: 'Ob-La-Di', neighborhood: 'Marais', address: '54 R. de Saintonge, Paris', price: 14, description: 'Healthy brunch café with açaí bowls and fresh juices.' },
    ],
    lunch: [
      { name: 'Le Comptoir du Panthéon', neighborhood: 'Latin Quarter', address: '5 R. Soufflot, Paris', price: 30, description: 'Classic Parisian terrace with Panthéon views.' },
      { name: 'Chez Janou', neighborhood: 'Marais', address: '2 R. Roger Verlomme, Paris', price: 40, description: 'Provençal bistro near Place des Vosges. Famous chocolate mousse.' },
    ...
    dinner: [
      { name: 'Le Petit Cler', neighborhood: '7th arrondissement', address: '29 R. Cler, Paris', price: 35, description: 'Charming neighborhood bistro on market street Rue Cler.' },
      { name: "Chez l'Ami Jean", neighborhood: '7th arrondissement', address: '27 R. Malar, Paris', price: 75, description: 'Basque gastro-bistro. Legendary rice pudding dessert.' },
      { name: 'Le Baratin', neighborhood: 'Belleville', address: '3 R. Jouye-Rouve, Paris', price: 45, description: 'Natural wine haven in Belleville with inspired French cooking.' },
      { name: 'Frenchie Bar à Vins', neighborhood: 'Sentier', address: '6 R. du Nil, Paris', price: 50, description: 'Gregory Marchand\'s wine bar with superb small plates.' },
      { name: 'Le Train Bleu', neighborhood: 'Gare de Lyon', address: 'Pl. Louis-Armand, Paris', price: 65, description: 'Spectacular Belle Époque restaurant inside Gare de Lyon. Opulent frescoed ceilings.' },
      { name: 'Brasserie Lipp', neighborhood: 'Saint-Germain-des-Prés', address: '151 Bd Saint-Germain, Paris', price: 55, description: 'Literary brasserie institution since 1880. Classic choucroute and steak tartare.' },
      { name: "Le Relais de l'Entrecôte", neighborhood: 'Saint-Germain', address: '20 R. Marbeuf, Paris', price: 50, description: 'One menu only: walnut salad then steak-frites with secret sauce.' },
      { name: 'Drouant', neighborhood: 'Opéra', address: '16-18 R. Gaillon, Paris', price: 70, description: 'Home of the Prix Goncourt literary prize. Elegant modern French cuisine.' },
      { name: 'Le Voltaire', neighborhood: 'Saint-Germain', address: '27 Quai Voltaire, Paris', price: 80, description: 'Intimate quayside bistro favored by artists and intellectuals.' },
      { name: 'Chez Georges', neighborhood: 'Bourse', address: '1 R. du Mail, Paris', price: 60, description: 'Unchanged since 1964. Handwritten menu, impeccable classic bistro fare.' },
    ],
  },
  'berlin': {
    breakfast: [
      { name: 'The Barn', neighborhood: 'Mitte', address: 'Auguststraße 58, Berlin', price: 12, description: 'Berlin\'s pioneering specialty coffee roaster. Minimalist, excellent.' },
      { name: 'House of Small Wonder', neighborhood: 'Mitte', address: 'Johannisstraße 20, Berlin', price: 20, description: 'Japanese-inspired brunch in a treehouse-like interior.' },
      { name: "Brammibal's Donuts", neighborhood: 'Kreuzberg', address: 'Maybachufer 8, Berlin', price: 10, description: 'Beloved vegan donut shop on the Landwehr Canal. Creative flavors.' },
      { name: 'Father Carpenter', neighborhood: 'Mitte', address: 'Münzstraße 21, Berlin', price: 15, description: 'Hidden courtyard coffee shop with excellent brunch menu.' },
    ],
    lunch: [
      { name: 'Curry 36', neighborhood: 'Kreuzberg', address: 'Mehringdamm 36, Berlin', price: 8, description: 'Berlin\'s most famous currywurst stand. A rite of passage.' },
      { name: 'Monsieur Vuong', neighborhood: 'Mitte', address: 'Alte Schönhauser Str. 46, Berlin', price: 16, description: 'Vietnamese street food in a stylish Mitte setting. Always packed.' },
      { name: 'Katz Orange', neighborhood: 'Mitte', address: 'Bergstraße 22, Berlin', price: 45, description: 'Slow food in a former brewery courtyard. Famous 12-hour roasted pork.' },
      { name: 'Cocolo Ramen', neighborhood: 'Mitte', address: 'Gipsstraße 3, Berlin', price: 14, description: 'Authentic Japanese ramen bar with rich tonkotsu broth.' },
    ],
    dinner: [
      { name: 'Pauly Saal', neighborhood: 'Mitte', address: 'Auguststraße 11-13, Berlin', price: 80, description: 'Former Jewish girls\' school turned elegant restaurant. Modern German cuisine.' },
      { name: 'Ora', neighborhood: 'Kreuzberg', address: 'Oranienpl. 14, Berlin', price: 50, description: 'Former pharmacy turned cozy restaurant. Seasonal European cuisine.' },
      { name: 'Lode & Stijn', neighborhood: 'Kreuzberg', address: 'Lausitzer Str. 25, Berlin', price: 65, description: 'Dutch-German tasting menu in a tiny Kreuzberg space.' },
      { name: 'eins44', neighborhood: 'Neukölln', address: 'Elbestraße 28/29, Berlin', price: 55, description: 'Former distillery in Neukölln with inventive German fine dining.' },
    ],
  },
  'rome': {
    breakfast: [
      { name: 'Roscioli Caffè', neighborhood: 'Centro Storico', address: 'Piazza Benedetto Cairoli 16, Rome', price: 18, description: 'Artisan pastries and specialty coffee from the famous Roscioli family.' },
      { name: 'Sciascia Caffè', neighborhood: 'Prati', address: 'Via Fabio Massimo 80/A, Rome', price: 10, description: 'Old-school Roman coffee bar known for its chocolate-rimmed espresso.' },
      { name: 'Barnum Café', neighborhood: 'Centro Storico', address: 'Via del Pellegrino 87, Rome', price: 12, description: 'Stylish modern café near Campo de\' Fiori. Great cappuccino.' },
      { name: 'Forno Campo de\' Fiori', neighborhood: 'Campo de\' Fiori', address: 'Piazza Campo de\' Fiori 22, Rome', price: 8, description: 'Famous bakery for pizza bianca and supplì. Morning staple.' },
    ],
    lunch: [
      { name: 'Da Enzo al 29', neighborhood: 'Trastevere', address: 'Via dei Vascellari 29, Rome', price: 30, description: 'Trastevere institution. Textbook cacio e pepe and carbonara.' },
      { name: 'Armando al Pantheon', neighborhood: 'Pantheon', address: 'Salita dei Crescenzi 31, Rome', price: 45, description: 'Family-run trattoria steps from the Pantheon. Classic Roman dishes for 60+ years.' },
      { name: 'Trattoria Da Teo', neighborhood: 'Trastevere', address: 'Piazza dei Ponziani 7A, Rome', price: 35, description: 'Hidden Trastevere gem with vine-covered terrace. Superb artichoke dishes.' },
      { name: 'Salumeria Roscioli', neighborhood: 'Centro Storico', address: 'Via dei Giubbonari 21, Rome', price: 50, description: 'Part deli, part restaurant. World-class cheese, salumi, and carbonara.' },
    ],
    dinner: [
      { name: 'Pierluigi', neighborhood: 'Centro Storico', address: 'Piazza de\' Ricci 144, Rome', price: 70, description: 'Elegant piazza dining. Renowned for seafood and celebrity clientele.' },
      { name: 'Felice a Testaccio', neighborhood: 'Testaccio', address: 'Via Mastro Giorgio 29, Rome', price: 45, description: 'The original cacio e pepe restaurant. A Roman pilgrimage dish.' },
      { name: 'Grazia & Graziella', neighborhood: 'Trastevere', address: 'Largo M.D. Fumasoni Biondi 5, Rome', price: 40, description: 'Charming Trastevere trattoria with Roman classics and garden seating.' },
      { name: 'Osteria Fernanda', neighborhood: 'Trastevere', address: 'Via Crescenzo del Monte 18, Rome', price: 60, description: 'Modern Roman cuisine with creative seasonal tasting menus.' },
    ],
  },
  'london': {
    breakfast: [
      { name: 'The Wolseley', neighborhood: 'Mayfair', address: '160 Piccadilly, London', price: 30, description: 'Grand European café-restaurant. The quintessential London breakfast.' },
      { name: 'Dishoom', neighborhood: 'Covent Garden', address: '12 Upper St Martin\'s Ln, London', price: 20, description: 'Bombay café. Legendary bacon naan roll and chai.' },
      { name: 'Buns from Home', neighborhood: 'Covent Garden', address: '24 Bedford St, London', price: 10, description: 'Italian-inspired brioche buns with creative fillings.' },
      { name: 'Granger & Co', neighborhood: 'Notting Hill', address: '175 Westbourne Grove, London', price: 22, description: 'Australian brunch pioneer. Famous ricotta hotcakes.' },
    ],
    lunch: [
      { name: 'Padella', neighborhood: 'Borough', address: '6 Southwark St, London', price: 18, description: 'Fresh handmade pasta near Borough Market. Queue early for the pici cacio e pepe.' },
      { name: 'Barrafina', neighborhood: 'Soho', address: '26-27 Dean St, London', price: 45, description: 'Michelin-starred Spanish tapas bar with buzzy counter seating.' },
      { name: 'Brasserie Zédel', neighborhood: 'Piccadilly', address: '20 Sherwood St, London', price: 25, description: 'Grand Parisian brasserie hidden beneath Piccadilly. Remarkable value.' },
      { name: 'Rochelle Canteen', neighborhood: 'Shoreditch', address: 'Arnold Circus, London', price: 30, description: 'Hidden gem in a converted school. Seasonal British cooking.' },
    ],
    dinner: [
      { name: 'St. John', neighborhood: 'Clerkenwell', address: '26 St John St, London', price: 60, description: 'Pioneering nose-to-tail restaurant. Fergus Henderson\'s bone marrow is a pilgrimage dish.' },
      { name: 'The Palomar', neighborhood: 'Soho', address: '34 Rupert St, London', price: 55, description: 'Modern Jerusalem cuisine. Sit at the bar for the full experience.' },
      { name: 'Quo Vadis', neighborhood: 'Soho', address: '26-29 Dean St, London', price: 65, description: 'Historic Soho institution with modern British cooking.' },
      { name: 'Brat', neighborhood: 'Shoreditch', address: '4 Redchurch St, London', price: 70, description: 'Wood-fired cooking. Michelin-starred whole turbot and Basque cheesecake.' },
    ],
  },
};
...
export function repairDay(input: RepairDayInput): RepairDayResult {
  ...
  // See plan.md (Venue descriptions on food cards).
  {
