...
**Now working through (owner-directed 2026-06-07 PM):** (1) ✅ tracker headline now reflects build-mode + DNA wins; (2) ✅ preferences→output (D3): dietary = 🟧 PARTIAL (C-PREF-1 logged); (3) → per-tool/partial credit charges; (4) navigation dead-ends; (5) DNA-accuracy traces.
