...
| C-PRICE-1 | ⬜ NEEDS OWNER | pricing model | **Observation, not yet a defect:** a non-first Multi-City trip charged **360 cr to GENERATE**, then shows "**5 Days · 0 Unlocked · 5 Locked · Unlock All Remaining 300 cr**" — i.e. pay-to-generate AND pay-to-unlock (~660 cr to actually view a 5-day trip). The confirm screen DID disclose "Day unlock charged separately," so it's transparent — but confirm this double-charge is intended vs. generation should unlock the days it generated. (First trip differs: 2 days free-unlocked.) | owner to confirm intended pricing model |
