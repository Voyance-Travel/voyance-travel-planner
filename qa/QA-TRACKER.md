...
| Swap / replace activity | ✅ | 🔴 | **C-TOOL-8 — replacement NOT persisted** (Florence: swapped to "La tenda rossa", lost on reload; old venue also gone, cost $185→$140) | trace swap persist path | ⏳ **fix shipped, verify pending (C-TOOL-8)** |
