      ...
      activity_costs: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["trip_id"]
            isOneToOne: false
            referencedRelation: "trips_with_audit_violations"
            referencedColumns: ["trip_id"]
          },
          {
            foreignKeyName: "activity_costs_trip_id_fkey"
      ...
      expense_splits: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["member_id"]
            isOneToOne: false
            referencedRelation: "public_trip_members"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "expense_splits_member_id_fkey"
    ...
    Views: {
      ...
      trips_with_audit_violations: {
        Row: {
          ...
          destination: string | null
          detail: string | null
          json_activity_count: number | null
          parity_delta: number | null
          severity: string | null
          table_activity_count: number | null
          trip_id: string | null
          user_id: string | null
        }
        Relationships: []
      }
      trips_with_chronology_issues: {
        Row: {
          critical_after_heal: boolean | null
          destination: string | null
          dropped: number | null
          issues_post: number | null
          issues_pre: number | null
          itinerary_status:
            | Database["public"]["Enums"]["itinerary_status"]
            | null
          sample: Json | null
          sorted_days: number | null
          traced_at: string | null
          trip_id: string | null
          user_id: string | null
        }
        Insert: {
          critical_after_heal?: never
          destination?: string | null
          dropped?: never
          issues_post?: never
          issues_pre?: never
