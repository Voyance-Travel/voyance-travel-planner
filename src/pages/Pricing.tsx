          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-card rounded-2xl border border-border p-6 shadow-sm">
                ...
                <Button variant="outline" className="w-full mb-4" onClick={() => navigate('/agent')}>
                  Learn More
                </Button>
                <ul className="space-y-2">
                  {PLAN_FEATURES.AGENT_STARTER.features.slice(0, 4).map((f, i) => (
                    <li key={i} className="flex items-start gap-2 text-sm">
                      <Check className="w-4 h-4 flex-shrink-0 mt-0.5 text-primary" />
                      <span className="text-foreground">{f}</span>
                    </li>
              ...
              <div className="bg-gradient-to-br from-card via-card to-primary/5 rounded-2xl border-2 border-primary p-6 relative shadow-lg shadow-primary/10">
                ...
                <Button className="w-full mb-4" onClick={() => navigate('/agent')}>
                  Learn More
                </Button>
                <ul className="space-y-2">
                  {PLAN_FEATURES.AGENT_PRO.features.slice(0, 4).map((f, i) => (
                    <li key={i} className="flex items-start gap-2 text-sm">
                      <Check className="w-4 h-4 flex-shrink-0 mt-0.5 text-primary" />
                      <span className="text-foreground">{f}</span>
                    </li>
              ...
              <div className="bg-card rounded-2xl border border-border p-6 shadow-sm">
                ...
                <Button variant="outline" className="w-full mb-4" onClick={() => navigate('/contact?subject=Agency')}>
                  Contact Sales
                </Button>
                <ul className="space-y-2">
                  {PLAN_FEATURES.AGENT_AGENCY.features.slice(0, 4).map((f, i) => (
                    <li key={i} className="flex items-start gap-2 text-sm">
                      <Check className="w-4 h-4 flex-shrink-0 mt-0.5 text-primary" />
                      <span className="text-foreground">{f}</span>
                    </li>
