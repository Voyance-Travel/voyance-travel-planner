...
export const PLAN_FEATURES = {
  FREE: {
    ...
    subheadline: 'Take the quiz, build a personalized itinerary, and preview Day 1 — completely free.',
...
export const COMPARISON_TABLE = {
  ...
  rows: [
    ...
    { feature: 'Personalized Itineraries', free: '✓', tripPass: '✓', credits5: '✓', credits10: '✓' },
    { feature: 'View All Days', free: 'Day 1 only', tripPass: 'All days', credits5: 'All days', credits10: 'All days' },
    { feature: 'AI Activity Swaps', free: '3 total', tripPass: 'Unlimited', credits5: '1 credit each', credits10: '1 credit each' },
