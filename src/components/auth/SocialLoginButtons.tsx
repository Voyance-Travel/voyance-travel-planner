  ...
  return (
    ...
    >
      ...
      <Button
        ...
        className="w-full h-12 bg-foreground hover:bg-foreground/90 border-foreground text-background font-medium"
      >
        {isLoadingApple ? (
          <span className="flex items-center gap-2">
            <span className="animate-spin rounded-full h-4 w-4 border-2 border-background/40 border-t-transparent" />
            Connecting...
          </span>
        ) : (
          <span className="flex items-center gap-3">
