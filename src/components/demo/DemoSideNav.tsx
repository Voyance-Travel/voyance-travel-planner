...
export function DemoSideNav({ showTour }: DemoSideNavProps) {
  ...
  return (
    <>
      {/* Mobile/Tablet - Compact bottom pill matching reference design */}
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 lg:hidden">
        <motion.div
          ...
          className="relative"
        >
          {/* Dropdown menu - appears above the pill */}
          <AnimatePresence>
            {isExpanded && (
              <motion.div
                ...
                className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-52 bg-card border border-border shadow-xl rounded-xl overflow-hidden"
              >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-card border border-border shadow-lg rounded-full"
          >
