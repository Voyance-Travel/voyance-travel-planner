...
// forwardRef SVG icons to prevent ref warnings when used inside anchor tags
...
const PinterestIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  function PinterestIcon(props, ref) {
    return (
      <svg ref={ref} viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" {...props}>
