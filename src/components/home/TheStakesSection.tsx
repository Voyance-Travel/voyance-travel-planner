        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              <div className="w-8 sm:w-10 h-1 bg-primary rounded-full" />
            ...
            {/* Headline */}
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-normal text-foreground mb-4 sm:mb-6 leading-[1.1]">
              Your next trip
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start">
              <Button asChild size="lg" className="text-sm sm:text-base px-6 sm:px-8 py-5 sm:py-6 font-medium shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all w-full sm:w-auto">
                <Link to={ROUTES.QUIZ}>
                  {stakes.cta}
                  <ArrowRight className="ml-2 sm:ml-3 h-4 w-4" />
                </Link>
              </Button>
              <p className="text-xs sm:text-sm text-muted-foreground sm:self-center text-center w-full sm:w-auto">
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`flex items-center gap-4 sm:gap-6 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-border/50 bg-card/50 backdrop-blur-sm hover:bg-card/80 transition-all ${
                    index === 2 ? 'bg-primary/5 border-primary/20' : ''
                  }`}
                >
                  <div className={`w-10 sm:w-14 h-10 sm:h-14 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0 ${
                  ...
                  <div className="flex-1 min-w-0">
                    <div className={`text-2xl sm:text-3xl font-bold ${
                      ...
                      {stat.value}{index === 2 && <span className="text-sm sm:text-lg ml-1">min</span>}
                    </div>
                  ...
                  {index === 2 && (
                    <div className="text-[10px] sm:text-xs font-medium text-primary bg-primary/10 px-2 sm:px-3 py-1 rounded-full hidden sm:block">
                      With Voyance
                    </div>
                  )}
                </motion.div>
