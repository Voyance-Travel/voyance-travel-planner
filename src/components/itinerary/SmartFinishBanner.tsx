...
export function SmartFinishBanner({
  ...
  const handleRetryEnrichment = async () => {
    ...
    try {
      ...
      // Mark as purchased in the DB — it was reset to false during the failed run.
      // Without this, page reload re-reads smart_finish_purchased=false and the banner reappears.
      await supabase
        .from('trips')
