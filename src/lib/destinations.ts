...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    gettingAround: 'Walk within the walled city. Taxis are cheap—agree on price before. Boats to Rosario Islands from the port.',
    localTips: [
  ...
  },
  {
    ...
    localTips: [
      'Dinner starts at 9-10pm—earlier and you\'ll eat alone',
