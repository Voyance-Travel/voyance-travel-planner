...
import { EXCHANGE_RATES_FROM_USD, convertFromUSD } from '../../supabase/functions/_shared/exchange-rates';
import { RATES_AS_OF_LABEL } from '../../supabase/functions/_shared/exchange-rates';
