...
// ============================================================================
// WALKING LEG DETECTION — walks are always free, regardless of stored category.
// ============================================================================
...
/**
 * True when this activity is a walking leg that should never carry a cost.
 * Excludes booked guided "walking tour" experiences (real ticket cost).
 */
export function isWalkingLeg(activity: {
  title?: string | null;
  name?: string | null;
