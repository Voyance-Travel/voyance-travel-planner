// src/lib/schema-compiler/keep-activities-filler.ts
// Pre-fill "kept" activities from a previous generation into schema slots.
// These are activities the user chose to preserve during regeneration.
//
// ISOLATION: This file imports ONLY from:
//   - @/types/schema-generation (Fix 22A types)
//   - ./time-parser (local utility)
