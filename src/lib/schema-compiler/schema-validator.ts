// src/lib/schema-compiler/schema-validator.ts
// Post-generation validation: checks AI response against compiled schema.
// Part of the isolated schema generation system (Fix 22A-E)
//
// ISOLATION: Imports only from schema-generation types.
// Does NOT import from or modify existing post-processing code.
...
export function validateAgainstSchema(
  ...
  // Check 1: Slot count match
  validations.push(checkSlotCount(schema, corrected));

  // Check 2: Filled slot integrity
