...
export {
  ...
  type UpdateReviewInput as ReviewUpdateInput,
  ...
  getReviewStats,
  voteReview,
  updateReview as updateReviewItem,
  deleteReview as deleteReviewItem,
  reviewKeys,
  useReviews,
  useActivityReviews,
  useReviewStats,
  useCreateReview,
  useUpdateReview as useUpdateReviewItem,
  useDeleteReview as useDeleteReviewItem,
  useVoteReview,
  getStarRating,
  getRatingLabel,
  getTravelTypeLabel,
...
export {
  type MealPace,
  type AdventureLevel,
  type ReservationUrgency as MealReservationUrgency,
  type CuisinePreferences,
  type MealStyle,
  type MealPreferences,
  type MealRecommendation,
  type MealDay,
  type BookingRequirement as MealBookingRequirement,
  type MealPlan as TripMealPlan,
  type RegenerateMealPlanInput,
  getMealPlan,
  regenerateMealPlan,
  updateMealPreferences as updateTripMealPreferences,
  getBookingRequirements as getMealBookingRequirements,
  mealPlanKeys,
  useMealPlan,
  useBookingRequirements as useMealBookingRequirements,
  useRegenerateMealPlan,
  useUpdateMealPreferences as useUpdateTripMealPreferences,
  getMealTypeIcon,
  getUrgencyColor as getMealUrgencyColor,
  isUrgentBooking as isMealUrgentBooking,
} from './mealPlanningAPI';

// User Stats API
export {
  type TripSummary as UserStatsTripSummary,
  type TripStats as UserStatsTripStats,
  type CountryVisit,
  type CountryStats,
  type CountriesResponse,
  type NextTrip as UserStatsNextTrip,
  type NextTripResponse as UserStatsNextTripResponse,
  type UserProfile as UserStatsProfile,
  type UserProfileResponse as UserStatsProfileResponse,
  type UpdateProfileInput as UserStatsUpdateProfileInput,
  getTripStats as getUserTripStats,
  getCountriesVisited,
  getNextTrip as getUserNextTrip,
  getUserProfile as getUserStatsProfile,
  updateUserProfile as updateUserStatsProfile,
  userStatsKeys,
  useTripStats as useUserTripStats,
  useCountriesVisited,
  useNextTrip as useUserNextTrip,
  useUserProfile as useUserStatsProfile,
  useUpdateUserProfile as useUpdateUserStatsProfile,
  formatDaysUntil,
  getUserDisplayName,
} from './userStatsAPI';
...
// Enhanced Trips API
export {
  type TripStatus as EnhancedTripStatus,
  type DisplayStatus,
  type SortBy as TripSortBy,
  type SortOrder as TripSortOrder,
  type TripMetadata,
  type Trip as EnhancedTrip,
  type CreateTripInput as EnhancedCreateTripInput,
  type UpdateTripInput as EnhancedUpdateTripInput,
  type ListTripsParams,
  type TripsListResponse,
  type CreateTripWithItineraryResponse,
  type ShareTripResponse,
  type SharedTripResponse,
  getTrips as getEnhancedTrips,
  getTrip as getEnhancedTrip,
  createTripWithItinerary,
  createTrip as createEnhancedTrip,
  updateTrip as updateEnhancedTrip,
  deleteTrip as deleteEnhancedTrip,
  shareTrip,
  getSharedTrip,
  tripsKeys as enhancedTripsKeys,
  useTrips as useEnhancedTrips,
  useTripDetail,
  useSharedTrip,
  useCreateTripWithItinerary,
  useCreateTrip as useCreateEnhancedTrip,
  useUpdateTrip as useUpdateEnhancedTrip,
  useDeleteTrip as useDeleteEnhancedTrip,
  useShareTrip,
  mapToDisplayStatus,
  getStatusColor as getTripStatusColor,
  hasItinerary as tripHasItinerary,
  formatTripDates,
} from './tripsEnhancedAPI';

// Emotional Tagging API (V2)
export {
  type EmotionalType,
  type EmotionalUrgency,
  type DisruptionType as EmotionalDisruptionType,
  type TimeWindow as EmotionalTimeWindow,
  type EmotionalTagInput,
  type EmotionalTag as EmotionalTagV2,
  type BudgetImpact,
  type ProtectedDay,
  type EmotionalProtection,
  type RescheduleEvaluation,
  type EmotionalRecommendation,
  createEmotionalTag as createEmotionalTagV2,
  getEmotionalTags as getEmotionalTagsV2,
  updateEmotionalTag as updateEmotionalTagV2,
  deleteEmotionalTag as deleteEmotionalTagV2,
  getEmotionalProtection,
  evaluateReschedule,
  getEmotionalRecommendations,
  emotionalTagsKeys as emotionalTagsKeysV2,
  useEmotionalTags as useEmotionalTagsV2,
  useEmotionalProtection,
  useRescheduleEvaluation,
  useEmotionalRecommendations,
  useCreateEmotionalTag,
  useUpdateEmotionalTag,
  useDeleteEmotionalTag,
  getEmotionalTypeEmoji,
  getEmotionalTypeLabel,
  getPriorityColor as getEmotionalPriorityColor,
  getImpactLevelColor,
  isDateProtected,
